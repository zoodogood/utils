				...
				!(function () {
					var s,
						...
						j = (e) => {
							var t = new j.Builder()
							return (
								t.pipeline.add(j.trimmer, j.stopWordFilter, j.stemmer),
								t.searchPipeline.add(j.stemmer),
								e.call(t, t),
								t.build()
							)
						}
					;(j.version = '2.3.9'),
						...
						(j.utils.asString = (e) => (null == e ? '' : e.toString())),
						(j.utils.clone = (e) => {
							if (null == e) return e
							for (
						...
						(j.Token.prototype.toString = function () {
							return this.str
						}),
						...
						(j.Token.prototype.clone = function (e) {
							return (
								(e = e || ((e) => e)),
								new j.Token(e(this.str, this.metadata), this.metadata)
							)
						}),
						(j.tokenizer = (e, t) => {
							...
							if (Array.isArray(e))
								return e.map(
									(e) =>
										new j.Token(
											j.utils.asString(e).toLowerCase(),
											j.utils.clone(t),
										),
								)
							for (
								...
								var a = s - o
								if (r.charAt(s).match(j.tokenizer.separator) || s == i) {
									if (a > 0) {
										var u = j.utils.clone(t) || {}
										;(u.position = [o, a]),
											(u.index = n.length),
											n.push(new j.Token(r.slice(o, s), u))
									}
									o = s + 1
								}
							}
						...
						(j.Pipeline.registeredFunctions = Object.create(null)),
						...
						(j.Pipeline.prototype.runString = function (e, t) {
							...
							return this.run([r]).map((e) => e.toString())
						}),
						...
						(j.Pipeline.prototype.toJSON = function () {
							return this._stack.map(
								(e) => (j.Pipeline.warnIfFunctionNotRegistered(e), e.label),
							)
						}),
						(j.Vector = function (e) {
							;(this._magnitude = 0), (this.elements = e || [])
						}),
						(j.Vector.prototype.positionForIndex = function (e) {
						...
						(j.trimmer = (e) =>
							e.update((e) => e.replace(/^\W+/, '').replace(/\W+$/, ''))),
						...
						(j.TokenSet._nextId = 1),
						(j.TokenSet.fromArray = (e) => {
							for (
								var t = new j.TokenSet.Builder(), r = 0, i = e.length;
								r < i;
								r++
							)
								t.insert(e[r])
						...
						(j.TokenSet.fromClause = (e) =>
							'editDistance' in e
								? j.TokenSet.fromFuzzyString(e.term, e.editDistance)
								: j.TokenSet.fromString(e.term)),
						(j.TokenSet.fromFuzzyString = (e, t) => {
							for (
								var r = new j.TokenSet(),
									i = [{ node: r, editsRemaining: t, str: e }];
								i.length;
							) {
								var n = i.pop()
								if (n.str.length > 0) {
									...
									o in n.node.edges
										? (s = n.node.edges[o])
										: ((s = new j.TokenSet()), (n.node.edges[o] = s)),
								...
								if (0 != n.editsRemaining) {
									...
									else (a = new j.TokenSet()), (n.node.edges['*'] = a)
									if (
										...
										else (u = new j.TokenSet()), (n.node.edges['*'] = u)
									...
									if (n.str.length > 1) {
										...
										h in n.node.edges
											? (l = n.node.edges[h])
											: ((l = new j.TokenSet()), (n.node.edges[h] = l)),
						...
						(j.TokenSet.fromString = (e) => {
							for (
								var t = new j.TokenSet(), r = t, i = 0, n = e.length;
								i < n;
								i++
							) {
								var s = e[i],
						...
						(j.Index.prototype.query = function (e) {
							...
							for (e.call(t, t), a = 0; a < t.clauses.length; a++) {
								...
								for (var h = 0; h < u.length; h++) {
									var d = u[h]
									l.term = d
									var f = j.TokenSet.fromClause(l),
										p = this.tokenSet.intersect(f).toArray()
									if (
										0 === p.length &&
										l.presence === j.Query.presence.REQUIRED
									) {
										for (var y = 0; y < l.fields.length; y++)
											s[(R = l.fields[y])] = j.Set.empty
										break
									}
									for (var m = 0; m < p.length; m++) {
										var g = p[m],
											...
											v = x._index
										for (y = 0; y < l.fields.length; y++) {
											var w = x[(R = l.fields[y])],
												Q = Object.keys(w),
												k = g + '/' + R,
												S = new j.Set(Q)
											if (
												(l.presence == j.Query.presence.REQUIRED &&
													((c = c.union(S)),
													void 0 === s[R] && (s[R] = j.Set.complete)),
												l.presence != j.Query.presence.PROHIBITED)
											) {
												if ((i[R].upsert(v, l.boost, (e, t) => e + t), !n[k])) {
													for (var b = 0; b < Q.length; b++) {
														var E,
															L = Q[b],
															P = new j.FieldRef(L, R),
															T = w[L]
														void 0 === (E = r[P])
															? (r[P] = new j.MatchData(g, R, T))
															: E.add(g, R, T)
													}
													n[k] = !0
												}
											} else
												void 0 === o[R] && (o[R] = j.Set.empty),
													(o[R] = o[R].union(S))
										}
									}
								}
								if (l.presence === j.Query.presence.REQUIRED)
									for (y = 0; y < l.fields.length; y++)
										s[(R = l.fields[y])] = s[R].intersect(c)
							}
							var O = j.Set.complete,
								I = j.Set.empty
							...
							if (t.isNegated())
								for (
									F = Object.keys(this.fieldVectors), a = 0;
									a < F.length;
									a++
								) {
									P = F[a]
									var C = j.FieldRef.fromString(P)
									r[P] = new j.MatchData()
								}
							for (a = 0; a < F.length; a++) {
								var D = (C = j.FieldRef.fromString(F[a])).docRef
								if (O.contains(D) && !I.contains(D)) {
									var A,
										B = this.fieldVectors[C],
										z = i[C.fieldName].similarity(B)
									if (void 0 !== (A = N[D]))
										(A.score += z), A.matchData.combine(r[C])
									else {
										var V = { ref: D, score: z, matchData: r[C] }
										;(N[D] = V), _.push(V)
									}
								}
							}
							return _.sort((e, t) => t.score - e.score)
						}),
						...
						(j.Index.load = (e) => {
							var t = {},
								...
								n = Object.create(null),
								s = e.invertedIndex,
								o = new j.TokenSet.Builder(),
								a = j.Pipeline.load(e.pipeline)
							e.version != j.version &&
								j.utils.warn(
						...
						(j.Builder.prototype.ref = function (e) {
							this._ref = e
						}),
						...
						(j.Builder.prototype.calculateAverageFieldLengths = function () {
							for (
								...
								var s = j.FieldRef.fromString(e[n]),
									o = s.fieldName
								i[o] || (i[o] = 0),
									(i[o] += 1),
									r[o] || (r[o] = 0),
						...
						(j.Builder.prototype.createFieldVectors = function () {
							for (
								...
								for (
									var s = j.FieldRef.fromString(t[n]),
										o = s.fieldName,
									...
									void 0 === i[x]
										? ((y = j.idf(this.invertedIndex[x], this.documentCount)),
											(i[x] = y))
										: (y = i[x]),
										(m =
											(y * ((this._k1 + 1) * v)) /
											(this._k1 *
												(1 -
													this._b +
													this._b * (a / this.averageFieldLength[o])) +
												v)),
										(m *= d),
										(m *= f),
						...
						(j.Builder.prototype.createTokenSet = function () {
							this.tokenSet = j.TokenSet.fromArray(
						...
						(j.MatchData.prototype.combine = function (e) {
							...
							if (t in this.metadata[e])
								for (var i = Object.keys(r), n = 0; n < i.length; n++) {
									...
									s in this.metadata[e][t]
										? (this.metadata[e][t][s] = this.metadata[e][t][s].concat(
												r[s],
											))
						...
						(j.Query.prototype.isNegated = function () {
							for (var e = 0; e < this.clauses.length; e++)
								if (this.clauses[e].presence != j.Query.presence.PROHIBITED)
									return !1
							return !0
						}),
						...
						(j.QueryParseError.prototype = new Error()),
						...
						(j.QueryLexer.prototype.run = function () {
						...
						(j.QueryLexer.lexField = (e) => (
							e.backup(),
							e.emit(j.QueryLexer.FIELD),
							e.ignore(),
							j.QueryLexer.lexText
						)),
						(j.QueryLexer.lexTerm = (e) => {
							if (
								(e.width() > 1 && (e.backup(), e.emit(j.QueryLexer.TERM)),
								e.ignore(),
								e.more())
							)
								return j.QueryLexer.lexText
						}),
						(j.QueryLexer.lexEditDistance = (e) => (
							e.ignore(),
							e.acceptDigitRun(),
							e.emit(j.QueryLexer.EDIT_DISTANCE),
							j.QueryLexer.lexText
						)),
						(j.QueryLexer.lexBoost = (e) => (
							e.ignore(),
							e.acceptDigitRun(),
							e.emit(j.QueryLexer.BOOST),
							j.QueryLexer.lexText
						)),
						(j.QueryLexer.lexEOS = (e) => {
							e.width() > 0 && e.emit(j.QueryLexer.TERM)
						}),
						(j.QueryLexer.termSeparator = j.tokenizer.separator),
						(j.QueryLexer.lexText = (e) => {
							for (;;) {
								var t = e.next()
								...
								if (92 != t.charCodeAt(0)) {
									...
									if ('-' == t && 1 === e.width())
										return e.emit(j.QueryLexer.PRESENCE), j.QueryLexer.lexText
									if (t.match(j.QueryLexer.termSeparator))
										return j.QueryLexer.lexTerm
						...
						(j.QueryParser.prototype.parse = function () {
								...
								switch (i.type) {
									...
									default:
										throw (
											...
											new j.QueryParseError(r, i.start, i.end))
										)
								}
							}
						}),
						(j.QueryParser.parseField = (e) => {
							var t = e.consumeLexeme()
							if (null != t) {
								if (-1 == e.query.allFields.indexOf(t.str)) {
									var r = e.query.allFields
										...
										i =
											...
											"', possible fields: " +
											r
									throw new j.QueryParseError(i, t.start, t.end)
								}
								...
								if (null == n)
									throw (
										...
										new j.QueryParseError(i, t.start, t.end))
									)
								if (n.type === j.QueryLexer.TERM) return j.QueryParser.parseTerm
								throw (
									((i = "expecting term, found '" + n.type + "'"),
									new j.QueryParseError(i, n.start, n.end))
								)
							}
						}),
						(j.QueryParser.parseTerm = (e) => {
							var t = e.consumeLexeme()
							if (null != t) {
								...
								if (null != r)
									switch (r.type) {
										...
										default: {
											...
											throw new j.QueryParseError(i, r.start, r.end)
										}
									}
								else e.nextClause()
							}
						}),
						(j.QueryParser.parseEditDistance = (e) => {
							var t = e.consumeLexeme()
							if (null != t) {
						...
						void 0 ===
							(n =
								'function' == typeof (i = () => j) ? i.call(t, r, t, e) : i) ||
							(e.exports = n)
				})()
			},
		},
			...
			createIndex: (e) =>
				t()(function () {
					this.ref('id'),
						...
						t().multiLanguage &&
							t().languages &&
							this.use(t().multiLanguage.apply(t(), t().languages)),
						(this.metadataWhitelist = ['position']),
						this.pipeline.remove(t().stemmer),
						this.searchPipeline.remove(t().stemmer),
						e.forEach((e) => {
							this.add(n({ id: e[0] }, e[1]))
						})
				}),
			loadIndex: (e) => (
				t().multiLanguage &&
					t().languages &&
					t().multiLanguage.apply(t(), t().languages),
				t().Index.load(e)
			),
			query: (e, r) =>
				e.query((e) => {
					e.term(t().tokenizer(r), { boost: 100, usePipeline: !0 }),
						e.term(t().tokenizer(r), {
							boost: 10,
							usePipeline: !1,
							wildcard:
								t().Query.wildcard.LEADING | t().Query.wildcard.TRAILING,
						}),
						e.term(t().tokenizer(r), { boost: 1, editDistance: 1 })
				}),
		}
	})(),
		(window.__DOCS_LUNR__ = i)
})()
window.__DOCS_LUNR__.default.init((x) => {
	;(function () {
		/*!
					...
					generateTrimmer: (r) => {
						...
						return (r) =>
							'function' == typeof r.update
								? r.update((r) => r.replace(t, '').replace(i, ''))
				...
				(e.ru.stemmer = (() => {
							...
							function d() {
								...
								if (((W.ket = W.cursor), (e = W.find_among_b(q, 4))))
									switch (((W.bra = W.cursor), e)) {
										case 1:
											if (
												(W.slice_del(), (W.ket = W.cursor), !W.eq_s_b(1, 'н'))
											)
												break
											W.bra = W.cursor
										case 2:
					...
					return (e) =>
						'function' == typeof e.update
							? e.update((e) => (t.setCurrent(e), t.stem(), t.getCurrent()))
