...
test('Plularization', () => {
	expect(
		pluralization_of_numeric(122, GrammaticGender.She, [
			'{} клубник',
			'{} клубника',
			'{} клубники',
		]),
	...
	expect(
		pluralization_of_numeric(919, GrammaticGender.She, [
			'{} клубник',
			'{} клубника',
			'{} клубники',
		]),
	...
	expect(
		pluralization_of_numeric(999_999, GrammaticGender.She, [
			'{} клубник',
			'{} клубника',
			'{} клубники',
		]),
	...
	expect(
		pluralization_of_numeric(1001, GrammaticGender.She, [
			'{} клубник',
			'{} клубника',
			'{} клубники',
		]),
	...
	expect(
		pluralization_of_numeric(-22, GrammaticGender.It, [
			'{} солнц',
			'{} солнце',
			'{} солнца',
		]),
